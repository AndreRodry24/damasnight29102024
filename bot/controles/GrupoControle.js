...
async filtroAntiLink(c, mensagemBaileys, botInfo) {
    try {
        ...
        const donoDoGrupo = '558599495181@s.whatsapp.net'; // ID do dono do grupo
            ...
            if (usuarioTexto) {
                ...
                if (textoComUrl) {
                    if (remetente === donoDoGrupo) {
                        ...
                        // Se o remetente for um admin que não é o dono do grupo, apaga a mensagem
                        ...
                        await socket.removerParticipante(c, id_chat, remetente); // Remove o usuário do grupo
                        return false;
                    }
                }
            }
